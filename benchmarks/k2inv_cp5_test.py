# CP5 gate: Tikhonov ridge on the tf32 TC path (use_tc_pinv=True, kappa_star=5)
...
r = _C.forward(q, k, v, m, nw, KS, True); k2inv = r[5].float(); K2 = r[11].float()
...
def fn_grads():
    ...
    o = FlashNystromFunction.apply(q, k, v, m, nw, True, KS, True); o.backward(dO)
